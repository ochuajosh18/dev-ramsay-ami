...
const ArticleUpdateForm = (): JSX.Element => {
  ...
  const articleToUpdate = useSelector(selectArticleById(articleId));
  ...
  function onSubmit(values: ArticleInputs) {
    ...
    if (media) {
      ...
      dispatch(updateArticle(articleId, updatedArticle, media as File));
      ...
      dispatch(updateArticle(articleId, updatedArticle));
    }
  }
