...
import bannerColumns from "./PrimaryBannerColumns";
import { selectModifiedBanners } from "../../../store/banner/selectors";
import { paginate, sort } from "../../../utils/helpers";

const PrimaryBannerTable = ({
  rowsPerPage,
  searchKeyword,
  ...
  const data = useSelector(selectModifiedBanners, shallowEqual);
  const columns = React.useMemo<TableColumn[]>(() => bannerColumns, []);
...
export default PrimaryBannerTable;
