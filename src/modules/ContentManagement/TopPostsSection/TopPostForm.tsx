...
import { createTopPost } from "../../../store/top-posts/actions";
import { labelStyle } from "../styles";

const TopPostForm = (): JSX.Element => {
  ...
  function onSubmit(values: ArticleInputs) {
    ...
    if (media) {
      ...
      dispatch(createTopPost(newArticle, media as File));
    } else if (videoLink) {
      newArticle = { title, content, datePosted, isEnabled, media: videoLink };
      dispatch(createTopPost(newArticle));
    }
  }
